...
public class ZplConverter {
    ...
    public static void main(String[] args) throws Exception {
        BufferedImage orginalImage = ImageIO.read(new File("C:\\Users\\Dev 39\\eclipse-workspace\\hello\\tmp\\logo.jpg"));
        ZplConverter zp = new ZplConverter();
        zp.setCompressHex(true);
        zp.setBlacknessLimitPercentage(50);
        System.out.println("res :"+ zp.convertfromImg(orginalImage));
    }
}